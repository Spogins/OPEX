...
gulp.task('scripts', function() {
	return gulp.src([
		...
		'app/libs/jquery/dist/jquery-ui-1.10.4.custom.min.js',
		'app/libs/count/jquery.countTo.js',
		'app/libs/swiper/dist/js/swiper.min.js',
		'app/libs/gallery/simple-lightbox.min.js',
		'app/libs/parallax/scrollax.min.js',
		'app/libs/picturefill/picturefill.min.js',
		'app/libs/sticky-sidebar/stickyfill.min.js',
		'app/libs/scroll/jquery.mCustomScrollbar.js',
		'app/libs/table/jquery.basictable.min.js',
		'app/libs/tooltip/dist/js/tooltipster.bundle.min.js',
...
gulp.task('rsync', function() {
	...
	.pipe(rsync({
		root: 'app/',
		hostname: 'sitego00.ftp.tools',
		destination: 'sitego.com.ua/www/nut',
