...
from src.wagtailvideos.permissions import permission_policy as video_permission_policy
...
class BaseVideoForm(BaseCollectionMemberForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "file" in self.fields:
            ...
            self.fields["file"].label = _("File")  # set field.label for file
...
class VideoTranscodeAdminForm(forms.Form):
    media_format = EnumField(MediaFormats, label=_("Media format"))
    quality = EnumField(VideoQuality, label=_("Quality"))
