...
class BaseVideoChooseView(BaseChooseView):
    ...
    def get_object_list(self):
        return permission_policy.instances_user_has_any_permission_for(self.request.user, ["choose"]).select_related(
            "collection",
        )
...
class VideoChooseView(VideoChooseViewMixin, VideoCreationFormMixin, BaseVideoChooseView):
    pass


class VideoChooseResultsView(ChooseResultsViewMixin, VideoCreationFormMixin, BaseVideoChooseView):
    pass
...
class VideoUploadView(VideoUploadViewMixin, VideoCreationFormMixin, VideoChosenResponseMixin, View):
    pass
